...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', or 'none' for activities without difficulty)
    """
    ...
    if difficulty:
        if difficulty == "none":
            # "none" means activities WITHOUT a difficulty field
